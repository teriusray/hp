				...
				<div class="header-inner">
					...
					<nav role="navigation">
						<ul>
                            ...
                            <li><a href="<c:url value='/cn'/>">中文</a></li>
		...
		<div class="container">
		   <div class="row">
                ...
                <div class="col-md-3 item-block animate-box text-center" data-animate-effect="fadeIn">
                    <figure>
                        <img src="<c:url value='/resources/img/house/service/management.png'/>" alt="" class="img-responsive center-img">
                    </figure>
					<h3>マネジメント</h3>
                </div>
                <div class="col-md-3 item-block animate-box text-center" data-animate-effect="fadeIn">
                    <figure>
                        <img src="<c:url value='/resources/img/house/service/clean.png'/>" alt="" class="img-responsive center-img">
                    </figure>
                    <h3>家事代行</h3>
                </div>
                <div class="col-md-3 item-block animate-box text-center" data-animate-effect="fadeIn">
                    <figure>
                        <img src="<c:url value='/resources/img/house/service/rent.png'/>" alt="" class="img-responsive center-img">
                    </figure>
                    <h3>賃貸</h3>
                </div>
                <div class="col-md-3 item-block animate-box text-center" data-animate-effect="fadeIn">
                    <figure>
                        <img src="<c:url value='/resources/img/house/service/tax.png'/>" alt="" class="img-responsive center-img">
                    </figure>
                    <h3>税金</h3>
                </div>
		   </div>
			...
			<div class="form-horizontal" id="index_form">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="input1" class="col-lg-3 control-label">ご希望の価格（予算）</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <label for="input1" class="col-lg-3 control-label">物件種別</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">購入目的</label>
                        <div class="col-lg-6">
                            <label class="radio-inline">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">エリア</label>
                        <div class="col-lg-6">
                            <label class="radio-inline">
                    ...
                    <div class="form-group">
                        <label for="input2" class="col-lg-3 control-label">お名前</label>
                        <div class="col-lg-6">
                            <input type="text" name="name" class="form-control" id="input2" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input3" class="col-lg-3 control-label">電話番号</label>
                        <div class="col-lg-6">
